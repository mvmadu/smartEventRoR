...
Solução:
	O nosso projeto viabiliza um calendário onde o usuário poderá agendar eventos fora do cotidiano, e também terá uma lista onde o usuário listará somente os eventos do cotidiano, a função será parecida com uma grade de horários escolar, onde você coloca o horário das aulas, dos intervalos, da entrada e da saída.
